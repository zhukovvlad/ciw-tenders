...
структурная валидация. Фонд решений (§9) отложен на отдельный PR. Дефолт пока RAG (`matching_engine='rag'`);
движок включается явным переводом конфига. Спека и результаты спайка (94.9% top-1 vs 77% RAG на бенчмарке):
